...
/**
 * From CodePath, but I(htaihm) fixed the bug that the listener gets stuck if any network call
 * failed. Some methods like {@link #notifyLoadMoreFailed()}, {@link #notifyNoMoreItems()} and
 * {@link #enableLoadMore(boolean)} has to be called appropriate for this class to function
 * properly.
 */
